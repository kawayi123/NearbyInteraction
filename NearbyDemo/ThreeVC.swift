...
//    @IBOutlet weak var actionButton: UIButton!
    ...
    let logger = os.Logger(subsystem: "com.nearby.demo.NearbyDemo", category: "ThreeVC")
    ...
    @IBAction func HostAction(_ sender: UIButton, forEvent event: UIEvent) {
        mpcManager.startAdvertising()
    }
    @IBAction func JoinAction(_ sender: UIButton, forEvent event: UIEvent) {
        print("invite send")
        mpcManager.sendInvite(threeVC: self)
    }
    @IBAction func SendAction(_ sender: UIButton, forEvent event: UIEvent) {
    ...
    override func viewDidLoad() {
        ...
        logger.info("Connecting to uuidString: \(UIDevice.current.identifierForVendor!.uuidString)")
...
//        updateInfoLabel(with: "\(niManager.distance)m")
    }
...
extension ThreeVC: NISessionDelegate {
