...
有关此示例的许可信息，请参阅许可证文件夹。



摘要：

一个使用核心蓝牙管理与附件的连接和数据传输的类。
...
//    static let txCharacteristicUUID = CBUUID(string: "6E400003-B5A3-F393-E0A9-E50E24DCCA9E")
    ...
    static let serviceUUID = CBUUID(string: "0AB2B471-B8F4-4378-BB07-A2472E76E2A4")
    static let rxCharacteristicUUID = CBUUID(string: "0AB2B471-B8F4-4378-BB07-A2472E76E2A4")
    static let txCharacteristicUUID = CBUUID(string: "0AB2B471-B8F4-4378-BB07-A2472E76E2A4")
//    static let serviceUUID = CBUUID(string: "6FD7B2B1-88FC-4388-ABB3-10699B7B974E")
//    static let rxCharacteristicUUID = CBUUID(string: "6FD7B2B1-88FC-4388-ABB3-10699B7B974E")
//    static let txCharacteristicUUID = CBUUID(string: "6FD7B2B1-88FC-4388-ABB3-10699B7B974E")
}
...
//    let logger = os.Logger(subsystem: "com.example.apple-samplecode.NINearbyAccessorySample", category: "DataChannel")
    let logger = os.Logger(subsystem: "com.nearby.demo.NearbyDemo", category: "DataChannel")
    ...
    *停止错误或已完成的连接。注意，`didUpdateNotificationStateForCharacteristic`
...
extension DataCommunicationChannel: CBCentralManagerDelegate {
    ...
    *该协议需要一个“CentralManagerDipDateState”实现。

    *通过检查其状态是否正确，确保您可以使用中央处理器

    *“poweredOn”。你的应用程序可以检查其他状态以确保可用性，例如
